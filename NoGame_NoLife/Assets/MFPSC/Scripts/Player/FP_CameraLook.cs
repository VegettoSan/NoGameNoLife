...
public class FP_CameraLook : MonoBehaviour
{
	...
	public Slider SensibilidadShoot;
    ...
    void Start()
    {
		...
		SensibilidadShoot.value = PlayerPrefs.GetFloat ("SencibilidadShoot", 1f);
    ...
    void Update()
    {
		...
		ShootSensitivity = SensibilidadShoot.value;

		SensibilidadLook.minValue = 0.5f;
		SensibilidadShoot.minValue = 0.5f;
		SensibilidadLook.maxValue = 4f;
		SensibilidadShoot.maxValue = 4f;

		NLook.text = SensibilidadLook.value.ToString();
		NShoot.text = SensibilidadShoot.value.ToString();

		PlayerPrefs.SetFloat ("SencibilidadTouch", SensibilidadLook.value);
		PlayerPrefs.SetFloat ("SencibilidadShoot", SensibilidadShoot.value);
	...
	public void AjutesDefault() {
		...
		SensibilidadShoot.value = 1f;

		PlayerPrefs.DeleteKey ("SencibilidadTouch");
		PlayerPrefs.DeleteKey ("SencibilidadShoot");
